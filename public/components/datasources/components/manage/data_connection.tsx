...
export const DataConnection = (props: { dataSource: string }) => {
  ...
  useEffect(() => {
    const searchDataSourcePattern = new RegExp(`flint_${_.escapeRegExp(datasourceDetails.name)}_.*`);
  ...
  const onclickAccelerationsCard = () => {
    renderCreateAccelerationFlyout(dataSource, datasourceDetails.connector);
  };
