...
export const TablesFlyout = ({ dataSourceName, dataSourceType, resetFlyout }: TablesFlyoutProps) => {
  ...
  useEffect(() => {
    if (dataSourceName && selectedDatabase) {
      ...
      if (
        ...
        startLoadingTables(dataSourceName, selectedDatabase, undefined, dataSourceType );
